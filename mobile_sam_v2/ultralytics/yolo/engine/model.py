...
from mobile_sam_v2.ultralytics import yolo  # noqa
from mobile_sam_v2.ultralytics.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SegmentationModel,
...
from mobile_sam_v2.ultralytics.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, NUM_THREADS, RANK, ROOT,
                                    callbacks, is_git_dir, yaml_load)
from mobile_sam_v2.ultralytics.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from mobile_sam_v2.ultralytics.yolo.utils.downloads import GITHUB_ASSET_STEMS
from mobile_sam_v2.ultralytics.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    def __init__(self, model: Union[str, Path] = 'yolov8n.pt', task=None) -> None:
        ...
        if self.is_hub_model(model):
            from mobile_sam_v2.ultralytics.hub.session import HUBTrainingSession
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        if not hasattr(self.predictor, 'trackers'):
            from mobile_sam_v2.ultralytics.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from mobile_sam_v2.ultralytics.yolo.utils.benchmarks import benchmark
    ...
    def tune(self,
        ...
        try:
            from mobile_sam_v2.ultralytics.yolo.utils.tuner import (ASHAScheduler, RunConfig, WandbLoggerCallback, default_space,
