...
from mobile_sam_v2.ultralytics.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, __version__
from mobile_sam_v2.ultralytics.yolo.utils.checks import check_version
...
def model_info_for_loggers(trainer):
    ...
    if trainer.args.profile:  # profile ONNX and TensorRT times
        from mobile_sam_v2.ultralytics.yolo.utils.benchmarks import ProfileModels
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    Usage:
        from pathlib import Path
        from mobile_sam_v2.ultralytics.yolo.utils.torch_utils import strip_optimizer
