...
from mobile_sam_v2.ultralytics.hub.utils import HUB_API_ROOT, PREFIX, smart_request
from mobile_sam_v2.ultralytics.yolo.utils import LOGGER, __version__, checks, emojis, is_colab, threaded
from mobile_sam_v2.ultralytics.yolo.utils.errors import HUBModelError
...
class HUBTrainingSession:
    ...
    Attributes:
        ...
        model (Dict): Model data fetched from mobile_sam_v2.ultralytics HUB.
    ...
    def _get_model(self):
        """Fetch and return model data from mobile_sam_v2.ultralytics HUB."""
