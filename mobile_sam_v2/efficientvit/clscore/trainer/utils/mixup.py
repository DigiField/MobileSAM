...
from mobile_sam_v2.efficientvit.apps.data_provider.augment import rand_bbox
from mobile_sam_v2.efficientvit.models.utils.random import torch_randint, torch_shuffle
